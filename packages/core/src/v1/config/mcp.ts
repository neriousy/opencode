...
export const Local = Schema.Struct({
  ...
  placement: Schema.optional(Schema.Literal("client")).annotate({
    description: "Run this local MCP server from the active interactive client and expose it to remote/WSL servers.",
  }),
