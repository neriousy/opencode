...
const createPlatform = (password: Accessor<string | null>): Platform => {
  ...
  const stores = (() => {
    ...
    const getStore = (name: string) => {
      ...
      const store = Store.load(name).catch((error) => {
        console.error("Failed to load tauri store", name, error)
    ...
    const storage: Platform["storage"] = (name = "default.dat") => {
  ...
  return {
    ...
    update: async () => {
      ...
      await stores.flushAll().catch(() => undefined)
